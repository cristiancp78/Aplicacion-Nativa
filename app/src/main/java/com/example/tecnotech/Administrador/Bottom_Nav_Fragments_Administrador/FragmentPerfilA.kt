...
class FragmentPerfilA : Fragment(R.layout.fragment_perfil_a) {
    ...
    private lateinit var binding: FragmentPerfilABinding
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        binding = FragmentPerfilABinding.inflate(LayoutInflater.from(mContext), container, false)

        binding.imgAPerfil.setOnClickListener {
            seleccionarImg()
        }

        binding.btnGuardarInfoA.setOnClickListener {
            actualizarInfo()
        }
    ...
    private fun actualizarInfo() {
        nombres = binding.nombresAPerfil.text.toString().trim()
        correo = binding.correoAPerfil.text.toString().trim()
        cedula = binding.cedulaAPerfil.text.toString().trim()
        ...
        ref.child("${firebaseAuth.uid}")
            .addValueEventListener(object : ValueEventListener {
                override fun onDataChange(snapshot: DataSnapshot) {
                    ...
                    binding.nombresAPerfil.setText(nombres)
                    binding.correoAPerfil.setText(correo)
                    binding.cedulaAPerfil.setText(cedula)
                    binding.fechaRegistroAPerfil.text = "Se unio el $fecha"
                    ...
                    try {
                        Glide.with(mContext)
                            ...
                            .into(binding.imgAPerfil)
                    }catch (e: Exception){

                    }


                    binding.correoAPerfil.isEnabled = false
